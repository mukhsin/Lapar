...
public class Map3Activity extends AppCompatActivity implements OnMapReadyCallback {

    public static final String TAG = Map3Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(Map3Activity.this);
...
//                            dialog = dialogb.create();
                    ...
                    map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                        ...
                        public boolean onMarkerClick(Marker marker) {
                            ...
                            AlertDialog.Builder dialogb = new AlertDialog.Builder(Map3Activity.this);
                            LayoutInflater inflater = LayoutInflater.from(Map3Activity.this);
                            imgview = inflater.inflate(R.layout.image_view, null);
                            img = (ImageView) imgview.findViewById(R.id.markerImage);
                            img.setImageBitmap(bitmap);
                            dialogb.setTitle(addresses.get(0).getFeatureName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_logout:
                loading = ProgressDialog.show(Map3Activity.this, "Loading", "Logging out...", true);
                ...
                ParseUser.logOutInBackground(new LogOutCallback() {
                    ...
                    public void done(ParseException e) {
                        ...
                        if (e == null) {
                            // Success
                            Intent intent = new Intent(Map3Activity.this, LoginActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            // Error
                            AlertDialog.Builder builder = new AlertDialog.Builder(Map3Activity.this);
